...
const items = [
  {
    year: '2025 — Present',
    tag: 'Startup',
    title: 'Co-Founded ARGUS',
    desc: 'Launched ARGUS with Antonio — a security and intelligence platform for Web3 / Solana. Shipping four products in parallel and driving real traction across the ecosystem.',
    accent: '◆',
  },
  {
    year: '2025',
    ...
    desc: 'Shipped the ARGUS DeFi defense layer: real-time exploit detection, economic-anomaly alerting, and protocol-side response automation.',
    accent: '🛡',
  },
  {
    year: '2025',
  ...
  },
  {
    ...
    tag: 'Product',
    title: 'Mosaic — Live',
    desc: 'On-chain intelligence aggregator — the data backbone behind ARGUS, composing signals across protocols, chains, and oracles into a queryable surface.',
    accent: '🧩',
  },
  {
    year: '2025',
    ...
    desc: 'Internal AI-augmented venture studio that lets ARGUS prototype, validate, and ship new product bets at a velocity normally reserved for much bigger teams.',
    accent: '🤖',
  },
  {
    year: '2026',
