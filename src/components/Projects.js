...
const projects = [
  {
    ...
    title: 'ARGUS',
    desc: 'Security and intelligence platform for the Web3 / Solana ecosystem. Co-founded with Antonio. ARGUS builds the unified safety and intelligence layer for DeFi protocols, validators, and on-chain applications — currently shipping four products in production (Protocol Guardian, SolGuard, Mosaic, and an AI Venture Studio) and driving real traction in the Solana Brazil ecosystem.',
    stack: ['Solana', 'Security', 'On-chain Intel', 'AI', 'Cloud', 'Founder'],
    link: 'https://github.com/janneh2000',
    featured: true,
    metrics: [
      { val: '4', label: 'Products Shipping' },
      { val: '2', label: 'Co-Founders' },
      { val: '2025 →', label: 'Building Since' },
    ],
  },
  {
    badge: { type: 'product', label: '🛡 ARGUS · Product' },
    title: 'Protocol Guardian',
    desc: 'Real-time security monitoring and defense layer for DeFi protocols. Watches contracts for exploit signatures, economic anomalies, and governance attacks — routes alerts and triggers protocol-side responses before damage spreads. Built to be the default incident layer for DeFi teams operating on-chain.',
    stack: ['Rust', 'Anchor', 'Solana', 'Real-time Alerting', 'Web3 Security'],
    link: 'https://github.com/janneh2000',
  },
  {
    badge: { type: 'product', label: '🛡 ARGUS · Product' },
  ...
  },
  {
    badge: { type: 'product', label: '🛡 ARGUS · Product' },
    title: 'Mosaic',
    desc: 'On-chain intelligence aggregator. Composes signals across protocols, chains, and oracles into a single queryable data surface for analysts, traders, and risk teams. Mosaic is the data backbone behind ARGUS\'s security and venture-studio products — and a standalone API layer for outside builders.',
    stack: ['TypeScript', 'Python', 'On-chain Data', 'Helius RPC', 'Postgres'],
    link: 'https://github.com/janneh2000',
  },
  {
    badge: { type: 'product', label: '🛡 ARGUS · Product' },
    title: 'AI Venture Studio',
    desc: 'AI-augmented venture studio inside ARGUS. Internal tooling that pairs LLM-driven ideation, prototyping, and GTM playbooks with the team\'s build velocity — the engine behind how we ship multiple ARGUS products in parallel and explore adjacent product bets without spinning up new teams.',
